...
3. **Urðarbrunnr keeps the record** — the Entity Framework foundation: entity base types, DbContext foundations, conventions, value converters, and the migrations chassis, so persistence starts lawful instead of becoming lawful.
